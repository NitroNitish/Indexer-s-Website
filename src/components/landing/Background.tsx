  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute -top-40 left-1/4 h-[40rem] w-[40rem] rounded-full opacity-50 blur-3xl"
      >
      ...
      <motion.div
        ...
        className="absolute top-[20rem] right-0 h-[36rem] w-[36rem] rounded-full opacity-40 blur-3xl"
      >
